...
(this.wordle.bundle = (function (e) {
  ...
  Ka.innerHTML =
    ...
    .concat(
      4e3, // CHANGE THIS
      ';\n  }\n\n  #game {\n    width: 100%;\n    max-width: var(--game-max-width);\n    margin: 0 auto;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n  }\n  header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-1);\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n  header .title {\n    font-weight: 700;\n    font-size: 36px;\n    letter-spacing: 0.2rem;\n    text-transform: uppercase;\n    text-align: center;\n    position: absolute;\n    left: 0;\n    right: 0;\n    pointer-events: none;\n  }\n\n  @media (max-width: 360px) {\n    header .title {\n      font-size: 22px;\n      letter-spacing: 0.1rem;\n    }\n  }\n\n  #board-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-grow: 1;\n    overflow: hidden;\n  }\n  #board {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    grid-gap: 5px;\n    padding:10px;\n    box-sizing: border-box;\n  }\n  button.icon {\n    background: none;\n    border: none;\n    cursor: pointer;\n    padding: 0 4px;\n  }\n\n  #debug-tools {\n    position: absolute;\n    bottom: 0;\n  }\n\n  </style>\n  <game-theme-manager>\n    <div id="game">\n      <header>\n        <div class="menu">\n          <button id="help-button" class="icon" aria-label="help">\n            <game-icon icon="help"></game-icon>\n          </button>\n        </div>\n        <div class="title">\n         <img src="./favicon/ms-icon-310x310.png" width="35px" style="vertical-align:middle; margin-top:-5px;">trokes <sub><span style="font-size:0.7em; font-color:gray">5劃Wordle</span></sub>\n        </div>\n        <div class="menu">\n          <button id="statistics-button" class="icon" aria-label="statistics">\n            <game-icon icon="statistics"></game-icon>\n          </button>\n          <button id="settings-button" class="icon" aria-label="settings">\n            <game-icon icon="settings"></game-icon>\n          </button>\n        </div>\n      </header>\n        <div id="board-container">\n          <div id="board"></div>\n        </div>\n        <game-keyboard></game-keyboard>\n        <game-modal></game-modal>\n        <game-page></game-page>\n        <div class="toaster" id="game-toaster"></div>\n        <div class="toaster" id="system-toaster"></div>\n    </div>\n  </game-theme-manager>\n  <div id="debug-tools"></div>\n'
    );
  var Qa = document.createElement("template");
  Qa.innerHTML =
  ...
  ***************************************************************************** */
                        ...
                        a.forEach(function (e) {
                          ...
                          text: ""
                            ...
                            .concat(
                              ...
                              .trimEnd()
                              .concat(
                                "\n @langtextic http://langtextic.github.io"
                              )
                            ),
                        }
                      );
  ...
  // CHANGE THIS
  Ps.innerHTML =
    '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>一日六次機會，競猜五劃謎底！<br>謎底是一至五劃組成的中文單字或詞語。筆劃分類如下：</p>    \n<p>一：橫（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Cjk_k_str_h.svg/1920px-Cjk_k_str_h.svg.png" height="16px" style="vertical-align: middle; margin-top: -3px;">）、提（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Cjk_k_str_u.svg/1920px-Cjk_k_str_u.svg.png" height="16px" style="vertical-align: middle; margin-top: -3px;">）<br>丨：竪（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Cjk_k_str_v.svg/1280px-Cjk_k_str_v.svg.png" height="16px" style="vertical-align: middle; margin-top: -3px;">）、竪鈎（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Cjk_k_str_vj.svg/1920px-Cjk_k_str_vj.svg.png" height="16px" style="vertical-align:middle; margin-top: -3px;">）<br>丿：撇（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Cjk_k_str_t.svg/1280px-Cjk_k_str_t.svg.png" height="16px" style="vertical-align: middle; margin-top: -3px;">）<br>ヽ：點（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Cjk_k_str_d.svg/1920px-Cjk_k_str_d.svg.png" height="16px" style="vertical-align:middle; margin-top: -3px;">）、捺（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Cjk_k_str_p.svg/1280px-Cjk_k_str_p.svg.png" height="16px" style="vertical-align:middle; margin-top: -3px;">）<br>乚：其餘含有轉折的筆劃，例如橫鈎（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Cjk_k_str_hj.svg/1280px-Cjk_k_str_hj.svg.png" height="16px" style="vertical-align:middle; margin-top: -3px;">）、豎曲鈎（<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Cjk_k_str_vaj.svg/1280px-Cjk_k_str_vaj.svg.png" height="16px" style="vertical-align:middle; margin-top: -3px;">）等<br>⎵：若謎底不足五劃，則在最後補上空格</p>\n      <p>輸入答案並按「ENTER」鍵提交後，方格會變成不同顏色作提示。</p>\n      <div class="examples">\n        <p><strong>例子</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="ヽ"></game-tile>\n            <game-tile letter="乚"></game-tile>\n            <game-tile letter="乚"></game-tile>\n            <game-tile letter="丿" evaluation="correct" reveal></game-tile>\n            <game-tile letter="ヽ"></game-tile>\n          </div>\n          <p>答案有 <strong>「丿」</strong> 這個筆劃，而且位置正確。</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="一" evaluation="present" reveal></game-tile>\n            <game-tile letter="丿"></game-tile>\n            <game-tile letter="ヽ"></game-tile>\n            <game-tile letter="丿"></game-tile>\n            <game-tile letter="ヽ"></game-tile>\n          </div>\n          <p>答案有<strong>「一」</strong>這個筆劃，但是位置錯誤。</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="丨"></game-tile>\n            <game-tile letter="乚"></game-tile>\n            <game-tile letter="一"></game-tile>\n            <game-tile letter="一"></game-tile>\n            <game-tile letter="⎵" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>答案沒有<strong>「⎵」</strong>空格。</p>\n        </div>\n      </div>\n  <p>5trokes 5劃Wordle由<a href="https://langtextic.github.io" target="_blank">言語字聊</a>參考<a href="https://chaaklau.github.io/zidou/" target="_blank">粵拼版字道</a>改編而成。</p><p>鳴謝：<br>英文原創版 - <a href="https://powerlanguage.co.uk/wordle" target="_blank">Wordle</a> by <a href="https://powerlanguage.co.uk/" target="_blank">Josh Wardle</a><br>中文倉頡版 - <a href="https://samuello.io/" target="_blank">Samuel Lo</a>創作<a href="http://samuello.io/jndle/" target="_blank">JNDLE字道</a><br>中文粵拼版 - <a href="https://twitter.com/chaakming" target="_blank">阿擇</a>創作<a href="https://chaaklau.github.io/zidou/" target="_blank">ZIDOU字道</a></p> </div>\n    </div>\n      \n  </div>\n  </section>\n';
  var Hs = (function (e) {
    r(t, e);
    var a = h(t);
